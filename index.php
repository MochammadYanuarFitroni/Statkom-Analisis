...
<head>
  ...
  <title> tugas statistika komputasi</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Pengumpulan Data Hasil Survey</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQ8v5fekERPtIz7ebBq-8uIo9gNww9Bnz8kpOR7skUN0UYitoxWQA0JVKjmdlgKP5gNuKDJvmo-ucHy/pubhtml?gid=1125562764&single=true" width="100%" frameborder=0 style="height:80%;"></iframe>
    </section>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
